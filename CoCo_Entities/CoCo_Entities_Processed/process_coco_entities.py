...
class DataProcessor:
    ...
    def process_val_rc(self, split="test", filter_no_box_ann=True):
...
if __name__ == "__main__":
    ...
    processor.process_val_rc(split="val", filter_no_box_ann=True)
    processor.process_val_rc(split="test", filter_no_box_ann=True)
